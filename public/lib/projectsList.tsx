...
export const projectsList = {
  ...
  "pebble-counter": {
    title: "pebble counter",
    imgSrc: "/ph-shop.jpg",
    imgAltDesc: "thumbnail image of pebble project",
    cardBrief:
      "game that has 9 holes where different neighbourhood cats could appear out of.",
    cardTech: ["JavaScript", "jQuery"],
    slug: "pebble-counter",
    description:
      "‘Catch Oscar’ is a game that has 9 holes where different neighbourhood cats could appear out of. Only one cat will show at one time and will disappear after a couple seconds.",
    url: "",
    github: "https://github.com/fyeung21/pebble-counter",
    technologies: ["HTML", "CSS", "JavaScript", "jQuery"],
    keyFeatures: [
      {
        imgSrc: "/ph-shop.jpg",
  ...
  minty: {
    title: "minty",
    imgSrc: "/dose-juice.jpg",
    imgAltDesc: "thumbnail image of minty project",
    cardBrief:
      "game that has 9 holes where different neighbourhood cats could appear out of.",
    cardTech: ["JavaScript", "jQuery"],
    slug: "minty",
    description:
      "‘Catch Oscar’ is a game that has 9 holes where different neighbourhood cats could appear out of. Only one cat will show at one time and will disappear after a couple seconds.",
    url: "",
    github: "https://github.com/fyeung21/minty",
    technologies: ["HTML", "CSS", "JavaScript", "jQuery"],
    keyFeatures: [
      {
        imgSrc: "/ph-shop.jpg",
