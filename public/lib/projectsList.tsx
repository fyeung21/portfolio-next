export const projectsList = [
  {
    ...
    reflection:
      "From this project I learned a lot about DOM manipulation, array manipulation, and string interpolation. There were also logic questions I did not know I had to clarify like what happens when randomizing produces the same result as the last result. Not only did I learn how to develop this kind of reaction game, I also learned a little about how designing a game works and how to properly communicate it. <h4>Future Considerations</h4> <ul><li>Improve on UI and UX design</li><li>Code refactoring, for example, change some if statements to switch cases.</li><li>Countdown after unpausing</li><li>Add a Leaderboard</li><li>Small bugs to clean up</li></ul>",
  },
  {
    id: 1,
